...
public interface WorkflowRunHistoryAPI {
    ...
    Single<Response<BaseResponse<List<WorkflowRunHistory>>>> retrieve(@Path("workflow_id")String workflow_id, @Path("execute_id")String execute_id, @Tag BaseReq baseReq);
